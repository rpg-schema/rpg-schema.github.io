      ...
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-parchment/20 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-parchment/50 text-sm">
            ...
            <p className="mt-1">Made with ❤️ in Bologna by <a href="https://www.fantasymaps.org" target="_blank" rel="noopener noreferrer" className="hover:text-parchment transition-colors">Fantasymaps.org</a></p>
          </div>
